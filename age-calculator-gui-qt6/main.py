...
class AgeCalculator(QWidget):
    def __init__(self):
        ...
        birthdate_name_label = QLabel("Date of Birth (DD/MM/YYYY):")
        ...
        grid.addWidget(birthdate_name_label, 1, 0)
    ...
    def calculate_age(self):
        ...
        year_of_bitrh = datetime.strptime(date_of_birth, "%d/%m/%Y").date().year
